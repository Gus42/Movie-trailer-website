...
avatar = media.Movie("Avatar",
                     ...
                     ("http://t0.gstatic.com/images?q=tbn:ANd9GcQCfmvrE4fMo2"
                      "cd8esc7mDZPtFSJThAujddMPkRtti1_ij6u-jp"),
                     "https://www.youtube.com/watch?v=5PSNL1qE6VY",
                     "James Cameron")
interstellar = media.Movie("Interstellar",
                           "A man go in space trying to save humanity",
                           ("https://lh5.googleusercontent.com/-_LZCNOpWcfI/"
                            "AAAAAAAAAAI/AAAAAAAAAAA/SEQ-XjwXhlU/s0-c-k-no-"
                            "ns/photo.jpg"),
...
cloud_atlas = media.Movie("Cloud Atlas",
                          "People of different time trying to be free",
